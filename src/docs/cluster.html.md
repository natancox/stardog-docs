...
2. if you're deploying to something else, [read the deployment recipe](https://github.com/clarkparsia/starman/wiki/How-to-deploy-Stardog-Cluster-manually) and adapt it to yr infrastructure
